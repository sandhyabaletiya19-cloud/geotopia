...
const mountainData = [
    ...
    { id: 38, name: "Annamite Range", highestPeak: "Phou Bia", elevation: 2819, image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800", background: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=1920", continent: "asia", countries: ["Vietnam", "Laos", "Cambodia"], flags: ["🇻🇳", "🇱🇦", "🇰🇭"], coords: { lat: 19.00, lng: 103.00, zoom: 6 }, length: "1,100 km", avgElevation: "1,000 m", formation: { origin: "Indo-China collision", age: "250 million years", plates: "Indo-Australian" }, peaks: [{ name: "Phou Bia", elevation: 2819, lat: 19.0100, lng: 103.1400 }],
