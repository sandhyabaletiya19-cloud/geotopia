...
(function () {
  ...
  const DATA = {
    ...
    physiographicRegions: [
      {
        ...
        coords: [
          [36.0, 70.0], [36.0, 74.0], [36.0, 78.0], [35.5, 80.0],
          [35.0, 82.0], [34.5, 84.0], [34.0, 86.0], [33.5, 88.0],
          [33.0, 90.0], [32.5, 92.0], [32.0, 94.0], [31.0, 96.0],
          [29.5, 97.0], [27.5, 95.5], [27.0, 93.5], [26.5, 91.5],
          [27.0, 89.5], [27.5, 87.5], [28.0, 85.5], [28.5, 83.5],
          [29.0, 81.5], [29.5, 79.5], [30.5, 77.5], [31.5, 76.0],
          [32.5, 74.5], [33.5, 73.0], [34.5, 72.0], [35.5, 71.0],
          [36.0, 70.0]
        ]
      },
      {
        ...
        coords: [
          [32.5, 74.5], [31.5, 76.0], [30.5, 77.5], [29.5, 79.5],
          [29.0, 81.5], [28.5, 83.5], [28.0, 85.5], [27.5, 87.5],
          [27.0, 89.5], [26.5, 91.5], [27.0, 93.5], [27.5, 95.5],
          [26.5, 95.5], [26.0, 95.0], [25.5, 94.0], [25.0, 93.0],
          [25.0, 91.5], [25.0, 90.0], [24.5, 88.5], [24.0, 87.5],
          [23.5, 86.5], [23.0, 85.0], [23.0, 83.5], [23.5, 82.0],
          [24.0, 80.5], [24.5, 79.0], [25.0, 77.5], [25.5, 76.5],
          [26.5, 75.5], [27.5, 74.5], [28.5, 73.5], [29.0, 73.0],
          [29.5, 72.5], [30.5, 73.0], [31.5, 73.5], [32.5, 74.5]
        ]
      },
      {
        ...
        coords: [
          [25.0, 77.5], [24.5, 79.0], [24.0, 80.5], [23.5, 82.0],
          [23.0, 83.5], [23.0, 85.0], [23.5, 86.5], [24.0, 87.5],
          [24.5, 88.5], [23.0, 88.0], [22.0, 87.5], [21.0, 86.5],
          [20.0, 85.5], [19.0, 84.5], [18.0, 83.5], [17.0, 82.5],
          [16.0, 81.0], [15.0, 80.0], [14.0, 79.5], [13.0, 79.5],
          [12.0, 79.5], [11.0, 79.0], [10.0, 78.0], [9.0, 77.5],
          [8.5, 77.5], [8.5, 76.5], [9.5, 76.2], [10.5, 75.8],
          [11.5, 75.5], [12.0, 75.0], [13.0, 74.8], [14.0, 74.5],
          [15.0, 74.0], [16.0, 73.8], [17.0, 73.5], [18.0, 73.2],
          [19.0, 72.8], [20.0, 73.0], [21.0, 73.2], [21.5, 73.5],
          [22.0, 74.0], [22.5, 75.0], [23.0, 76.0], [23.5, 77.0],
          [24.0, 77.5], [25.0, 77.5]
        ]
      },
      {
      ...
      },
      {
        ...
        coords: [
          [29.0, 73.0], [28.5, 71.5], [28.0, 70.0], [27.5, 69.0],
          [27.0, 68.0], [26.5, 67.0], [26.0, 66.5], [25.5, 67.0],
          [25.0, 68.0], [24.5, 68.5], [24.0, 68.5], [23.5, 68.5],
          [23.0, 69.0], [22.5, 70.0], [22.0, 71.0], [22.5, 71.5],
          [23.0, 72.0], [23.5, 72.5], [24.0, 73.0], [24.5, 73.5],
          [25.0, 73.5], [25.5, 73.0], [26.0, 73.0], [26.5, 73.5],
          [27.0, 74.0], [27.5, 74.5], [28.5, 73.5], [29.0, 73.0]
        ]
      },
      {
        id: 'islands',
    ...
    himalayanRanges: [
      {
        ...
        coords: [
          ...
          [35.0, 82.0], [34.5, 84.0], [34.0, 86.0], [33.5, 88.0],
          [33.0, 90.0], [32.5, 92.0], [32.0, 94.0], [31.0, 96.0],
          [30.5, 96.0], [31.5, 94.0], [32.0, 92.0], [32.5, 90.0],
          [33.0, 88.0], [33.5, 86.0], [34.0, 84.0], [34.5, 82.0],
          [35.0, 80.0], [35.2, 78.0], [35.2, 74.0], [35.2, 70.0],
          [36.0, 70.0]
        ]
      },
      {
        ...
        coords: [
          [35.2, 70.0], [35.2, 74.0], [35.2, 78.0], [35.0, 80.0],
          [34.5, 82.0], [34.0, 84.0], [33.5, 86.0], [33.0, 88.0],
          [32.5, 90.0], [32.0, 92.0], [31.5, 94.0], [30.5, 96.0],
          [29.5, 97.0], [28.5, 96.0], [28.0, 94.5], [27.5, 92.5],
          [27.0, 90.5], [27.0, 88.5], [27.2, 86.5], [27.5, 84.5],
          [28.0, 82.5], [28.5, 80.5], [29.5, 78.5], [30.5, 77.0],
          [31.5, 75.5], [32.5, 74.0], [33.5, 72.5], [34.5, 71.0],
          [35.2, 70.0]
        ]
      },
      {
        ...
        coords: [
          [34.5, 71.0], [33.5, 72.5], [32.5, 74.0], [31.5, 75.5],
          [30.5, 77.0], [29.5, 78.5], [28.5, 80.5], [28.0, 82.5],
          [27.5, 84.5], [27.2, 86.5], [27.0, 88.5], [27.0, 90.5],
          [27.5, 92.5], [28.0, 94.5], [28.5, 96.0], [27.5, 95.5],
          [27.0, 93.5], [26.5, 91.5], [26.5, 89.5], [26.8, 87.5],
          [27.0, 85.5], [27.2, 83.5], [27.5, 81.5], [28.0, 79.5],
          [29.0, 77.5], [30.0, 76.0], [31.0, 74.5], [32.0, 73.0],
          [33.0, 71.5], [34.5, 71.0]
        ]
      },
      {
        ...
        coords: [
          [33.0, 71.5], [32.0, 73.0], [31.0, 74.5], [30.0, 76.0],
          [29.0, 77.5], [28.0, 79.5], [27.5, 81.5], [27.2, 83.5],
          [27.0, 85.5], [26.8, 87.5], [26.5, 89.5], [26.5, 91.5],
          [27.0, 93.5], [27.5, 95.5], [26.5, 95.5], [26.0, 95.0],
          [25.5, 94.0], [25.0, 93.0], [25.0, 91.5], [25.0, 90.0],
          [25.2, 88.0], [25.5, 86.0], [25.8, 84.0], [26.0, 82.0],
          [26.2, 80.0], [26.5, 78.0], [27.0, 76.5], [28.0, 75.0],
          [29.0, 73.5], [29.5, 72.5], [30.5, 73.0], [31.5, 73.5],
          [32.5, 74.5], [33.0, 71.5]
        ]
      }
    ],
    ...
    westernGhats: {
      mainRange: [
        [21.5, 73.8], [20.5, 73.5], [19.5, 73.2], [18.5, 73.0],
        [17.5, 73.3], [16.5, 73.7], [15.5, 74.0], [14.5, 74.3],
        [13.5, 74.5], [12.5, 75.0], [11.5, 75.5], [10.8, 76.0],
        [10.0, 76.5], [9.0, 77.0], [8.5, 77.5],
        [8.8, 77.3], [9.2, 76.8], [10.0, 76.3], [10.8, 76.2],
        [11.5, 75.8], [12.5, 75.3], [13.5, 74.8], [14.5, 74.5],
        [15.5, 74.2], [16.5, 74.0], [17.5, 73.7], [18.5, 73.4],
        [19.5, 73.5], [20.5, 73.8], [21.5, 74.2], [21.5, 73.8]
      ],
      peaks: [
      ...
      subregions: [
        {
          ...
          color: '#FFD700',
          coords: [
            [32.5, 74.5], [32.0, 75.5], [31.5, 76.0],
            [31.0, 76.5], [30.5, 75.5], [30.0, 74.5],
            [29.5, 73.5], [29.0, 73.0], [29.5, 72.5],
            [30.5, 73.0], [31.5, 73.5], [32.5, 74.5]
          ],
        ...
        },
        {
          ...
          color: '#FFA500',
          coords: [
            [32.5, 74.5], [31.5, 73.5], [30.5, 73.0],
            [29.5, 72.5], [29.0, 73.0], [28.5, 74.0],
            [28.5, 75.5], [29.0, 76.0], [29.5, 76.5],
            [30.0, 76.8], [30.5, 77.0], [31.0, 76.5],
            [31.5, 76.0], [32.0, 75.5], [32.5, 74.5]
          ],
        ...
        },
        {
          ...
          color: '#FFB347',
          coords: [
            [30.5, 77.0], [30.0, 76.8], [29.5, 76.5],
            [29.0, 76.0], [28.5, 75.5], [28.5, 74.0],
            [28.0, 74.5], [27.5, 75.5], [27.0, 76.5],
            [27.0, 77.5], [27.2, 78.5], [27.5, 79.5],
            [28.0, 80.5], [28.5, 80.5], [29.0, 80.0],
            [29.5, 79.5], [30.0, 79.0], [30.5, 78.0],
            [30.5, 77.0]
          ],
        ...
        },
        {
          ...
          color: '#FF8C00',
          coords: [
            [28.5, 80.5], [28.0, 80.5], [27.5, 79.5],
            [27.2, 78.5], [27.0, 77.5], [27.0, 76.5],
            [26.5, 77.0], [26.0, 78.0], [25.5, 79.0],
            [25.0, 80.0], [24.5, 81.0], [24.5, 82.0],
            [24.8, 83.0], [25.2, 84.0], [25.5, 85.0],
            [26.0, 85.5], [26.5, 86.0], [27.0, 86.5],
            [27.5, 86.0], [27.5, 85.0], [27.8, 84.0],
            [28.0, 83.0], [28.2, 82.0], [28.3, 81.0],
            [28.5, 80.5]
          ],
        ...
        },
        {
          ...
          color: '#FF6347',
          coords: [
            [27.0, 86.5], [26.5, 86.0], [26.0, 85.5],
            [25.5, 85.0], [25.2, 84.0], [24.8, 83.0],
            [24.5, 82.0], [24.0, 83.0], [23.5, 84.0],
            [23.0, 85.0], [22.5, 86.0], [22.0, 87.0],
            [22.5, 88.0], [23.0, 88.5], [23.5, 88.5],
            [24.0, 88.0], [24.5, 87.5], [25.5, 87.0],
            [26.5, 87.0], [27.0, 86.5]
          ],
          notes: 'West Bengal. Hooghly delta. Dense population. Kolkata. Rice & jute.'
        },
        {
          name: 'Brahmaputra Plains',
          color: '#00CED1',
          coords: [
            [27.5, 89.5], [27.0, 89.5], [26.5, 90.0],
            [26.0, 90.5], [25.5, 91.0], [25.0, 92.0],
            [25.0, 93.5], [25.5, 94.5], [26.0, 95.5],
            [26.5, 95.5], [27.0, 95.0], [27.5, 94.0],
            [27.5, 93.0], [27.5, 92.0], [27.5, 91.0],
            [27.5, 90.0], [27.5, 89.5]
          ],
        ...
        },
        {
          ...
          color: '#8FBC8F',
          coords: [
            [30.0, 77.5], [30.0, 79.0], [30.0, 81.0],
            [30.0, 83.0], [30.0, 85.0], [30.0, 87.0],
            [29.5, 87.0], [29.5, 85.0], [29.5, 83.0],
            [29.5, 81.0], [29.5, 79.0], [29.5, 77.5],
            [30.0, 77.5]
          ],
        ...
        },
        {
          ...
          color: '#90EE90',
          coords: [
            [29.5, 77.5], [29.5, 79.0], [29.5, 81.0],
            [29.5, 83.0], [29.5, 85.0], [29.5, 87.0],
            [29.0, 87.0], [29.0, 85.0], [29.0, 83.0],
            [29.0, 81.0], [29.0, 79.0], [29.0, 77.5],
            [29.5, 77.5]
          ],
      ...
      regions: [
        {
          ...
          coords: [
            [25.0, 77.5], [25.5, 78.5], [25.5, 80.0],
            [25.0, 81.5], [24.5, 82.0], [24.0, 81.0],
            [23.5, 80.0], [23.0, 79.0], [23.0, 78.0],
            [23.5, 77.0], [24.0, 76.5], [24.5, 76.5],
            [25.0, 77.5]
          ],
        ...
        },
        {
          ...
          coords: [
            [22.0, 73.5], [21.5, 74.5], [21.0, 75.5],
            [20.5, 76.0], [20.0, 76.5], [19.5, 76.0],
            [19.0, 75.5], [18.5, 75.0], [18.0, 74.5],
            [17.5, 74.5], [17.0, 75.0], [16.5, 75.5],
            [16.0, 76.0], [15.5, 76.5], [15.0, 77.0],
            [14.5, 77.5], [14.0, 78.0], [14.0, 79.0],
            [15.0, 79.5], [16.0, 80.0], [17.0, 80.5],
            [18.0, 81.0], [19.0, 82.0], [20.0, 82.5],
            [21.0, 82.0], [21.5, 81.0], [22.0, 80.0],
            [22.5, 79.0], [23.0, 78.0], [23.0, 77.0],
            [22.5, 76.0], [22.0, 75.0], [22.0, 73.5]
          ],
        ...
        },
        {
          ...
          coords: [
            [24.0, 76.5], [24.5, 76.5], [25.0, 77.5],
            [24.5, 78.5], [24.0, 79.0], [23.5, 79.0],
            [23.0, 78.0], [23.0, 77.0], [23.5, 76.5],
            [24.0, 76.5]
          ],
        ...
        },
        {
          ...
          avg_height: '700-1000 m',
          coords: [
            [24.5, 82.0], [25.0, 81.5], [25.5, 82.5],
            [25.5, 84.0], [25.0, 85.5], [24.5, 86.5],
            [23.5, 86.5], [23.0, 85.5], [23.0, 84.5],
            [23.0, 83.5], [23.5, 82.5], [24.0, 82.0],
            [24.5, 82.0]
          ],
          notes: 'Jharkhand, Chhattisgarh. Oldest Archean rocks. Rich in minerals — iron, coal, mica. Damodar river.'
        },
        {
          ...
          coords: [
            [24.0, 81.0], [24.5, 82.0], [24.0, 82.0],
            [23.5, 82.5], [23.0, 83.5], [23.0, 82.5],
            [23.0, 81.5], [23.0, 80.5], [23.5, 80.0],
            [24.0, 81.0]
          ],
        ...
        },
        {
          ...
          avg_height: '300-600 m',
          coords: [
            [25.5, 78.5], [25.5, 80.0], [25.0, 81.5],
            [24.5, 82.0], [24.0, 81.0], [23.5, 80.0],
            [24.0, 79.0], [24.5, 78.5], [25.0, 78.0],
            [25.5, 78.5]
          ],
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    {
      ...
      render(map, app) {
        ...
        const westCoast = L.polygon([
          [21.5, 72.8], [20.5, 72.6], [19.5, 72.5], [18.5, 72.5],
          [17.5, 72.8], [16.5, 73.2], [15.5, 73.5], [14.5, 73.8],
          [13.5, 74.2], [12.5, 74.5], [11.5, 75.0], [10.5, 75.5],
          [9.5, 76.0], [8.5, 77.0], [8.5, 77.5],
          [9.5, 76.5], [10.5, 76.0], [11.5, 75.5], [12.5, 75.0],
          [13.5, 74.5], [14.5, 74.2], [15.5, 74.0], [16.5, 73.8],
          [17.5, 73.3], [18.5, 73.0], [19.5, 73.0], [20.5, 73.2],
          [21.5, 73.5], [21.5, 72.8]
        ], {
        ...
        const eastCoast = L.polygon([
          [22.0, 87.0], [21.0, 86.5], [20.0, 85.5], [19.0, 84.5],
          [18.0, 83.5], [17.0, 82.5], [16.0, 81.0], [15.0, 80.5],
          [14.0, 80.0], [13.0, 80.0], [12.0, 79.8], [10.5, 79.5],
          [9.0, 78.5], [8.5, 77.5],
          [9.0, 79.0], [10.5, 80.0], [12.0, 80.3], [13.0, 80.5],
          [14.0, 80.5], [15.0, 81.0], [16.0, 81.5], [17.0, 83.0],
          [18.0, 84.0], [19.0, 85.5], [20.0, 86.5], [21.0, 87.0],
          [22.0, 87.5], [22.0, 87.0]
        ], {
          color: '#20B2AA', fillColor: '#20B2AA', fillOpacity: 0.5, weight: 1.5
        });
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    {
      ...
      render(map, app) {
        ...
        const rangeLabels = [
          ...
          { name: 'MIDDLE HIMALAYAS\n(Himachal)', lat: 30.5, lng: 77.5, color: '#E67E22' },
          { name: 'OUTER HIMALAYAS\n(Shivalik)', lat: 28.5, lng: 78.5, color: '#E59866' }
        ];
        ...
        const thrustLines = [
          {
            ...
            color: '#FF00FF',
            coords: [
              [35.2, 70.5], [34.8, 74.0], [34.2, 78.0],
              [33.5, 82.0], [32.5, 86.0], [31.0, 90.0],
              [29.5, 94.0], [28.5, 96.0]
            ]
          },
          {
            ...
            color: '#FF6600',
            coords: [
              [34.5, 71.0], [33.5, 74.5], [32.5, 78.0],
              [31.5, 82.0], [30.5, 86.0], [29.0, 90.0],
              [27.5, 93.5], [27.0, 95.5]
            ]
          },
          {
            ...
            color: '#FFFF00',
            coords: [
              [33.0, 71.5], [32.0, 75.0], [31.0, 78.5],
              [30.0, 82.0], [29.0, 86.0], [27.5, 90.0],
              [26.5, 93.0], [26.0, 95.0]
            ]
          }
        ];
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    {
      ...
      render(map, app) {
        ...
        const cities = [
          ...
          { name: 'Kanpur', lat: 26.46, lng: 80.33 },
        ...
        const ranges = [
          {
            ...
            color: '#006400',
            coords: [
              [24.5, 73.7], [25.0, 73.5], [25.5, 73.5],
              [26.0, 73.7], [26.5, 74.0], [27.0, 74.5],
              [27.5, 75.0], [28.0, 76.0], [28.6, 77.2]
            ]
          },
          {
            name: 'Vindhya Range',
            color: '#8B0000',
            coords: [
              [22.0, 74.0], [22.2, 75.5], [22.5, 77.0],
              [23.0, 78.5], [23.5, 80.0], [24.0, 81.5],
              [24.5, 83.0]
            ]
          },
          {
            ...
            color: '#4B0082',
            coords: [
              [21.5, 73.8], [21.7, 75.0], [22.0, 76.5],
              [22.2, 78.0], [22.5, 79.5], [22.8, 81.0],
              [23.0, 82.0]
            ]
          },
          {
            ...
            color: '#228B22',
            coords: [
              [21.5, 73.8], [20.5, 73.5], [19.5, 73.2],
              [18.5, 73.0], [17.5, 73.3], [16.5, 73.7],
              [15.5, 74.0], [14.5, 74.3], [13.5, 74.5],
              [12.5, 75.0], [11.5, 75.5], [10.8, 76.0],
              [10.0, 76.5], [9.0, 77.0], [8.5, 77.5]
            ]
          },
          {
            ...
            color: '#556B2F',
            coords: [
              [22.0, 87.0], [21.0, 86.0], [20.0, 85.5],
              [19.0, 84.5], [18.0, 83.5], [17.5, 83.0],
              [17.0, 82.0], [16.0, 80.5], [15.5, 79.8],
              [15.0, 79.5], [14.0, 79.0], [13.0, 78.5],
              [12.0, 78.0], [11.5, 78.5]
            ]
          }
        ];
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    {
      ...
      render(map, app) {
        ...
        const eastGhatsLine = L.polyline([
          [22.0, 87.0], [21.0, 86.0], [20.0, 85.5],
          [19.0, 84.5], [18.5, 83.5], [18.0, 83.0],
          [17.5, 83.0], [17.0, 82.0],
          [16.0, 80.5], [15.5, 79.8],
          [15.0, 79.5], [14.0, 79.0],
          [13.0, 78.5], [12.0, 78.0], [11.5, 78.5]
        ], {
          color: '#556B2F',
          weight: 4,
          opacity: 0.8
        ...
        const westSubdivisions = [
          {
            ...
            color: '#006994',
            coords: [
              [23.8, 69.5], [24.2, 70.0], [24.5, 71.0],
              [24.2, 71.5], [23.5, 71.5], [23.0, 71.0],
              [22.5, 70.5], [22.0, 70.2], [22.5, 69.8],
              [23.0, 69.5], [23.8, 69.5]
            ]
          },
          {
            ...
            color: '#0077BE',
            coords: [
              [21.5, 72.8], [20.5, 72.6], [19.5, 72.5],
              [18.5, 72.5], [17.5, 72.8], [16.5, 73.2],
              [15.5, 73.5], [15.5, 74.2], [16.5, 73.8],
              [17.5, 73.3], [18.5, 73.0], [19.5, 73.0],
              [20.5, 73.2], [21.5, 73.5], [21.5, 72.8]
            ]
          },
          {
            name: 'Kanara Coast',
            color: '#0096C7',
            coords: [
              [15.5, 73.5], [14.5, 73.8], [13.5, 74.2],
              [12.5, 74.5], [12.5, 75.2], [13.5, 74.8],
              [14.5, 74.5], [15.5, 74.2], [15.5, 73.5]
            ]
          },
          {
            name: 'Malabar Coast',
            color: '#00B4D8',
            coords: [
              [12.5, 74.5], [11.5, 75.0], [10.8, 75.5],
              [10.0, 76.0], [9.0, 76.5], [8.5, 77.0],
              [8.5, 77.5], [9.0, 77.2], [10.0, 76.8],
              [10.8, 76.3], [11.5, 75.8], [12.5, 75.2],
              [12.5, 74.5]
            ]
          }
        ];
        ...
        const eastSubdivisions = [
          {
            ...
            color: '#FF8C00',
            coords: [
              [22.0, 87.0], [21.0, 86.5], [20.0, 85.5],
              [19.5, 85.0], [19.5, 86.0], [20.0, 87.0],
              [21.0, 87.5], [22.0, 87.5], [22.0, 87.0]
            ]
          },
          {
            name: 'Andhra Coast',
            color: '#FF7000',
            coords: [
              [19.5, 85.0], [18.5, 83.5], [17.5, 82.5],
              [16.5, 81.5], [15.5, 80.5], [15.0, 80.5],
              [15.5, 81.5], [16.5, 82.0], [17.5, 83.0],
              [18.5, 84.5], [19.5, 86.0], [19.5, 85.0]
            ]
          },
          {
            ...
            color: '#FF5500',
            coords: [
              [15.0, 80.5], [14.0, 80.0], [13.0, 80.0],
              [12.0, 79.8], [10.5, 79.5], [9.0, 78.5],
              [8.5, 77.5], [9.0, 78.8], [10.5, 80.0],
              [12.0, 80.3], [13.0, 80.5], [14.0, 80.5],
              [15.0, 81.0], [15.0, 80.5]
            ]
          }
        ];
      ...
      info: [
        ...
        },
        {
          ...
          items: [
            ...
            '10° Channel — between Little Andaman & Car Nicobar (150km)',
        ...
        const channels = [
          {
            ...
            coords: [[10.9, 92.5], [10.3, 92.6]],
            color: '#FFFF00'
          },
          {
            name: '10° Channel (150km)',
            coords: [[10.3, 92.6], [9.2, 92.8]],
            color: '#FF69B4'
          },
          {
            name: '8° Channel',
            coords: [[8.5, 73.5], [8.0, 72.8]],
            color: '#00FF88'
          },
          {
            name: '9° Channel',
            coords: [[8.0, 73.2], [7.0, 73.2]],
            color: '#00BFFF'
          }
        ];
